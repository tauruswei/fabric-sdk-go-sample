...
func getBCCSPFromOpts(config *gmfactory.GmOpts) (bccsp.BCCSP, error) {
...
func getOptsByConfig(c core.CryptoSuiteConfig) *gmfactory.GmOpts {
	opts := &gmfactory.GmOpts{
...
func getEphemeralOpts() *gmfactory.GmOpts {
	// todo 001
	opts := &gmfactory.GmOpts{
		HashFamily: "GMSM3",
		SecLevel:   256,
